            ...
            children: [
              {
                title: "프로젝트 생성", // required
                path:
                  "/ApacheNiFi/ControllerService/make-project-controller-service"
              },
              {
                title: "HikariCPControllerService-1", // required
                path:
                  "/ApacheNiFi/ControllerService/HikariCPControllerService-1"
              },
              {
                title: "HikariCPControllerService-2", // required
                path:
                  "/ApacheNiFi/ControllerService/HikariCPControllerService-2"
              },
              {
                title: "HikariCPControllerService-3", // required
                path:
                  "/ApacheNiFi/ControllerService/HikariCPControllerService-3"
              }
            ]
          }
        ]
        ...
        children: [
          {
            ...
            children: [
              ...
              {
                title: "Chapter9. JUnit으로 테스팅하기",
                path: "/Book/JAVA_INTERVIEW/09"
              }
            ]
          }
        ]
